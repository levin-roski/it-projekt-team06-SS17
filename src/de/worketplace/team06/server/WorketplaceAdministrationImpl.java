...
public class WorketplaceAdministrationImpl extends RemoteServiceServlet implements WorketplaceAdministration{
	 ...
	 *  gesetzt. Die Partnerprofile id kann zu einem spÃ¤tzeren Zeitpunkt Ã¼ber die savePerson Methode
	 *  gespeichert werden. 
	 *  
	 */
	public Person createPerson(String firstName, String lastName, String street, int zipcode, String city, String description, String googleID) throws IllegalArgumentException {
		...
		/**
		 *  Setzen einer vorlÃ¤ufigen ID. 
		 *  Der korrekte bzw vortlaufende PrimÃ¤rschlÃ¼ssel (=id) wird Ã¼ber eine Datenbankabfrage in der
		 *  personMapper.insert Methode generiert. (Die Id muss mit den DatensÃ¤tzen in der Datenbank
		 *  konsistent sein) 
		 */
		p.setID(1);
